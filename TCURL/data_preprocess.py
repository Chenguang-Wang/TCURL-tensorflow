...
def data_npz(good,bad,alphabet,dictionary,samples=50000,url_length=200,npz_filename='phishing.npz'):
        ...
        np.savez_compressed(npz_filename, X_test=x_test,  y_test=y_test_cat)

if __name__ == "__main__":

    parser = argparse.ArgumentParser()
    parser.add_argument('--url_length', type=int, default=200)
    parser.add_argument('--npz_filename', type=str, default='./data/new_url_dataset_test.npz')
    parser.add_argument('--n_samples',type=int, default=8000,help='number of good and bad samples.')
    ...
    df = pd.read_csv('phishing_and_benign_websites.csv')
